...
const MiramareVideo = () => {
  return (
    <div className="relative w-full h-[900px] bg-[url('https://miramarehotels.com/assets/frontend/images/homepage/homepage-video-background.webp')] " >
      ...
      <div className='absolute inset-0 flex items-center justify-center z-10'>
        <Link className=' flex ' href="https://www.youtube.com/embed/1Er9UedpVLI?si=--qNDHNSmLIGsRpK">
          <CgPlayButtonO className='w-[110px] h-[110px]  text-white'/>
        </Link>
      </div>

      <div className='absolute left-[70%] top-[40%] text-white text-center z-10'>
        <h2 className='text-4xl font-medium justify-end '>DREAM VACATION</h2>
